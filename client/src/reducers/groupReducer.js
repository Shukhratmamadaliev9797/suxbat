...
export const groupCoverUpdateReducer = (state = {}, action) => {
  switch (action.type) {
    case GROUP_COVER_UPDATE_REQUEST:
      return { loading: true };
    case GROUP_COVER_UPDATE_SUCCESS:
      return { loading: false, success: true };
    case GROUP_COVER_UPDATE_FAIL:
      return { loading: false, error: action.payload };
    case GROUP_COVER_UPDATE_RESET:
      return {};
    default:
      return state;
  }
