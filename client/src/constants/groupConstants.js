...
export const GROUP_FIND_FAIL = "GROUP_FIND_FAIL";

export const GROUP_ADD_POST_REQUEST = "GROUP_ADD_POST_REQUEST";
export const GROUP_ADD_POST_SUCCESS = "GROUP_ADD_POST_SUCCESS";
export const GROUP_ADD_POST_FAIL = "GROUP_ADD_POST_FAIL";

export const GROUP_COVER_UPDATE_REQUEST = "GROUP_COVER_UPDATE_REQUEST";
export const GROUP_COVER_UPDATE_SUCCESS = "GROUP_COVER_UPDATE_SUCCESS";
export const GROUP_COVER_UPDATE_FAIL = "GROUP_COVER_UPDATE_FAIL";
export const GROUP_COVER_UPDATE_RESET = "GROUP_COVER_UPDATE_RESET";
